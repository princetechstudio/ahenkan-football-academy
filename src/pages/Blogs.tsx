...
export default function Blogs() {
  ...
  return (
    <>
      ...
      <section className="relative bg-lav-50 py-20 lg:py-24">
            ...
            <article
              className={`group grid grid-cols-1 overflow-hidden border-2 transition-all duration-300 lg:grid-cols-12 ${
                expanded === featured.id
                  ? "border-royal-500 bg-paper shadow-[0_28px_70px_rgba(126,1,183,0.18)]"
                  : "border-ink/10 bg-paper hover:border-royal-500 hover:shadow-[0_20px_50px_rgba(126,1,183,0.14)]"
              }`}
            >
              <div className="relative overflow-hidden lg:col-span-6">
                ...
                />
                <span className="absolute left-0 top-6 bg-gold-500 px-4 py-1.5 font-cond text-sm font-bold uppercase tracking-[0.18em] text-ink">
                  ★ Featured
                </span>
              </div>
              <div className="flex flex-col p-7 sm:p-10 lg:col-span-6">
                <p className="flex items-center gap-3">
                  <span className="bg-royal-500 px-2.5 py-1 font-cond text-xs font-bold uppercase tracking-[0.16em] text-paper">
                    {featured.cat}
                  </span>
                  <span className="tabular font-cond text-sm font-semibold uppercase tracking-widest text-ink/50">
                    {featured.date}
                  </span>
                </p>
                ...
                <button
                  ...
                  className="group/b mt-7 inline-flex items-center gap-3 self-start font-cond text-base font-bold uppercase tracking-[0.16em] text-royal-500 transition-colors hover:text-royal-700"
                >
            ...
            {rest.map((n, i) => {
              ...
              return (
                <Reveal key={n.id} delay={(i % 3) * 100}>
                  <article
                    className={`flex h-full flex-col border-2 bg-paper transition-all duration-300 ${
                      open
                        ? "border-royal-500 shadow-[0_20px_50px_rgba(126,1,183,0.16)]"
                        : "border-ink/10 hover:-translate-y-1.5 hover:border-royal-500 hover:shadow-[0_18px_44px_rgba(126,1,183,0.14)]"
                    }`}
                  >
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      ...
                      <button
                        ...
                        className="group/b mt-auto inline-flex items-center gap-2 self-start pt-5 font-cond text-sm font-bold uppercase tracking-[0.14em] text-royal-500 transition-colors hover:text-royal-700"
                      >
